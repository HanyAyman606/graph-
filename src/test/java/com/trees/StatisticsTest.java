...
import com.trees.benchmark.Statistics;
...
class StatisticsTest{
 ...
 void median_emptyArray_throws(){
  assertThrows(IllegalArgumentException.class,()->Statistics.median(new long[]{}));
 }
 ...
 void mean_emptyArray_throws(){
  assertThrows(IllegalArgumentException.class,()->Statistics.mean(new long[]{}));
 }
 ...
 void stdDev_emptyArray_throws(){
  assertThrows(IllegalArgumentException.class,()->Statistics.stdDev(new long[]{}));
 }
